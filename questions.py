...
QUESTIONS = {
    ...
    "beginner": [
        ...
        {"q": "What is the plural of 'child'?",
         "options": ["childs", "children", "childes", "child"], "answer": "children"},
        {"q": "I ___ from Uzbekistan.",
         "options": ["is", "are", "am", "be"], "answer": "am"},
        {"q": "Choose the correct one:  This is ___ book.",
         "options": ["a", "an", "two", "many"], "answer": "a"},
        {"q": "What color is the sky on a clear day?",
         "options": ["green", "blue", "red", "brown"], "answer": "blue"},
        {"q": "___ you happy?",
         "options": ["Is", "Am", "Are", "Do"], "answer": "Are"},
        {"q": "Opposite of 'big':",
         "options": ["large", "tall", "small", "wide"], "answer": "small"},
        {"q": "They ___ my friends.",
         "options": ["is", "am", "are", "be"], "answer": "are"},
        {"q": "Which number is 'seven'?",
         "options": ["5", "6", "7", "9"], "answer": "7"},
    ],
    # ------------------------------------------------------------------ #
    "elementary": [
