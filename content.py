...
VOCABULARY = {
    ...
    "elementary": [
        ...
        {"word": "attack", "uz": "hujum qilmoq", "example": "The dog did not attack.", "example_uz": "It hujum qilmadi."},
        {"word": "cruel", "uz": "shafqatsiz", "example": "Do not be cruel to animals.", "example_uz": "Hayvonlarga shafqatsiz bo'lmang."},
        {"word": "finally", "uz": "nihoyat", "example": "Finally, we arrived home.", "example_uz": "Nihoyat, biz uyga yetib keldik."},
        {"word": "moment", "uz": "lahza", "example": "Wait a moment, please.", "example_uz": "Bir lahza kuting, iltimos."},
        {"word": "pleased", "uz": "mamnun", "example": "I am pleased to meet you.", "example_uz": "Siz bilan tanishganimdan mamnunman."},
        {"word": "shout", "uz": "baqirmoq", "example": "Do not shout in class.", "example_uz": "Sinfda baqirmang."},
        {"word": "smell", "uz": "hid / hidlamoq", "example": "The flowers smell nice.", "example_uz": "Gullar yoqimli hid taratadi."},
        {"word": "noise", "uz": "shovqin", "example": "The street is full of noise.", "example_uz": "Ko'cha shovqinga to'la."},
    ],
    "intermediate": [
